...
# python -m pytest -v tests\test_reg_invalid_password.py
...
@pytest.mark.parametrize("password, error_expected", [("", 1), ("Пароль78", 3), ("Passwo7", 1), ("password7", 2),
                         ...
                         ids=['empty str', 'rus', '7 chars', 'no caps', 'with space',
                              '', '', '', ''])
def test_reg_invalid_password(web_browser, password, error_expected):
    """ Тестирование вывода ошибки при вводе некорректного пароля """
    ...
    page.password_confirm_input.send_keys("The-password")
